...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>View All Hotel Data</h1>
        <a class="btn btn-success" href="{{ url('add-hotel')}}">Create</a>
        <ol class="breadcrumb">
            ...
            <table class="table table-striped table-bordered">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <img src="{{ asset('uploads/hotels/'.$show->hotel_image)}}" height="80px" width="80px" alt="image">
                        </td>
